...
import demo.tcyeee.config.filter.AuthenticationTokenFilter;
import demo.tcyeee.config.handler.EntryPointUnauthorizedHandler;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/version/**").permitAll()         // login目录下可以访问
